          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-lg hover:shadow-xl hover:shadow-indigo-200/50 transition-all duration-300 text-center">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Hands-on experience with AWS services for cloud-based
                  deployments.
                </p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-lg hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-300 text-center">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Terraform and Ansible for provisioning and managing cloud
                  resources.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-lg hover:shadow-xl hover:shadow-cyan-200/50 transition-all duration-300 text-center">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Tools like Prometheus, Grafana, and AWS CloudWatch to monitor
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 border border-white/50 shadow-xl shadow-blue-100/50">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                A DevOps Engineer driven by curiosity and a love for automation,
                scalability, and continuous improvement. My journey into DevOps
                began 1.5 years ago when I started exploring how modern cloud
                and automation tools transform software delivery.
              </p>

              {/* Paragraph 2 */}
              <p className="text-base text-gray-700 leading-relaxed mb-5">
                I completed a 3-month Cloud Training Program, where I gained
                hands-on experience with multiple AWS services and DevOps tools,
                and learned how to manage applications, automate workflows, and
                implement cloud-native solutions.
              </p>

              {/* Paragraph 3 */}
              <p className="text-base text-gray-700 leading-relaxed">
                I’ve worked on multiple self-driven projects — setting up CI/CD
                pipelines, automating infrastructure with Terraform,
                containerizing workloads with Docker and Kubernetes, and
                experimenting with monitoring stacks — all to deepen my
                understanding of real-world DevOps practices.
              </p>
                ...
                <div className="flex-1 md:w-1/2 md:pl-8 mt-4 md:mt-0">
                  <ul className="space-y-2.5 text-sm text-gray-700">
                    <li className="flex items-start">
                      <span className="text-blue-500 mr-2 font-bold">▹</span>
                      <span>
                        Completed the AWS re/Start Cloud Computing Programme in
                        collaboration with Accenture and Magic Bus India
                        Foundation!
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        and DevOps tools, and learned how to manage
                        applications, automate workflows, and implement
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 hover:border-blue-300 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-200/50">
                ...
                <ul className="text-sm text-gray-600 mb-4 leading-relaxed">
                  <li className="flex items-start">
                    ...
                    <span>
                      Eliminated insecure and manual deployments by building an
                      automated DevSecOps CI/CD pipeline with Jenkins, enforcing
                      100% security gates using SonarQube and Trivy before
                      deployment.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>
                      Reduced production risk by implementing multi-stage
                      vulnerability scanning (source + container image),
                      ensuring only validated Docker images are deployed to
                      Amazon EKS.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>
                      Improved deployment reliability and consistency by
                      automating container build, registry push, and Kubernetes
                      deployment, enabling repeatable releases with zero manual
                      intervention.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>
                      Increased system visibility and faster troubleshooting by
                      integrating Prometheus and Grafana, providing real-time
                      application and cluster-level monitoring.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 hover:border-purple-300 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-purple-200/50">
                ...
                <ul className="text-sm text-gray-600 mb-4 leading-relaxed">
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-2">•</span>
                    <span>
                      Solved manual and error-prone deployments by implementing
                      automated CI/CD and GitOps using GitHub Actions and
                      ArgoCD, enabling zero-touch deployments across 20+
                      microservices.
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      Addressed scalability and service management complexity by
                      deploying and orchestrating 20+ polyglot microservices on
                      Amazon EKS, ensuring consistent rollouts and controlled
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      Eliminated environment drift and manual infrastructure
                      setup by provisioning AWS resources (EKS, VPC, IAM) with
                      Terraform, achieving fully reproducible environments.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-pink-500 mr-2">•</span>
                    <span>
                      Reduced debugging and incident response time by
                      implementing end-to-end observability using Prometheus,
                      and Grafana, providing real-time visibility into metrics,
                      logs, and traces.
                    </span>
                  </li>
                </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-5 border border-white/50 shadow-lg hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {["EC2", "VPC", "IAM", "S3", "RDS", "EKS"].map((skill) => (
                    <span
                      key={skill}
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-5 border border-white/50 shadow-lg hover:shadow-xl hover:shadow-purple-200/50 transition-all duration-300">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-sm font-bold text-gray-800">GitOps</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {["ArgoCD"].map((skill) => (
                    <span
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-xl hover:shadow-2xl hover:shadow-blue-200/50 transition-all duration-300">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-base font-bold text-gray-800">SSC</h3>
                    <p className="text-sm text-gray-700 mt-1 font-medium">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 border border-white/50 shadow-xl">
              ...
              <div className="flex justify-center gap-4 mb-8 flex-wrap">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="md:hidden inline-flex items-center px-6 py-3
              ...
              <div className="hidden md:block bg-linear-to-br from-blue-50 to-purple-50 border border-blue-200/50 rounded-xl overflow-hidden shadow-inner">
                <iframe
                  src={`${deepakResume}#view=FitH`}
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-8 border border-white/50 shadow-xl">
              <p className="text-center text-sm text-gray-700 mb-8 leading-relaxed font-medium">
                Open to freelance work, technical collaborations, and new
